...
encrypted_key, iv, encrypted_data = encrypt_large_data(data, recipient_public_key)
#
...
print("encrypted_keyyyyyyyyyyyyyyyyyyyyyyyyy")
print(byte_dataencrypted_key)
...
with open(f"../data/indexx_encrypted.bin", 'wb') as file:
    file.write(encrypted_data)

# Read the encrypted data from the file
with open("../data/indexx_encrypted.bin", 'rb') as file:
